...
fn_makeSelectBox = function(){
	callBack.selectboxCreationCallBack("select");
}
...
$(document).ready(function(){
	...
	if(callBack == "callBack.selectboxCreationCallBack"){
		$("#btn_promptUpdate").hide();
		$("#btn_promptSave").show();
	}
	else if(callBack == "callBack.selectUpdateCallBack"){
...
<input type="button" class="btn_retrieve" value="취소" onclick="robot.closePop('',callBack.selectCreationCallBack);"></input>
